...
} ATTR_ALIGN(16) sse2_t;	/* On an 8-byte (64-bit) boundary */
typedef	union {
...
#define movlpd_r2m(reg,var)     mmx_r2m (movlpd,reg,var)
#define movhpd_r2m(reg,var)     mmx_r2m (movhpd,reg,var)

#define	movddup_r2r(regs,regd)	mmx_r2r (movddup, regs, regd)
